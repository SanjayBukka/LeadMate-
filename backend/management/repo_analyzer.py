...
class RepoAnalyzer:
    ...
    def clone_or_open_repo(self, repo_url: str, depth: int = 1) -> bool:
        ...
        try:
            if os.path.exists(self.repo_path):
                ...
                # Clone new repo with shallow depth
                self.repo = git.Repo.clone_from(repo_url, self.repo_path, depth=depth)
